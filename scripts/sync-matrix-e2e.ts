...
function openDevice(
  ...
  const cloudSync = new CloudSync(store.db, {
    LLM_MEM_CLOUD_SYNC_TOKEN: TOKEN,
    LLM_MEM_CLOUD_SYNC_USER_ID: USER_ID,
    LLM_MEM_CLOUD_SYNC_HUB_URL: hubUrl,
    LLM_MEM_CLOUD_SYNC_DEVICE_ID: DEVICE_IDS[name],
    LLM_MEM_CLOUD_SYNC_DEVICE_NAME: `Matrix ${name.toUpperCase()}`,
  }, {
