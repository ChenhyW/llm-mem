...
const STORAGE_KEY = 'llm-mem-welcome-dismissed-v3';
const EXPLAINER_URL = '/api/onboarding/explainer';
const DOCS_URL = 'https://docs.llm-mem.ai';
    ...
    <div className="welcome-modal-backdrop" onClick={handleDismiss}>
      ...
      >
        ...
        <header className="welcome-modal-header">
          <img className="welcome-modal-logo" src="llm-mem-logo-stylized.png" alt="" width="96" height="96" />
          <h2 id="welcome-modal-title">Welcome to llm-mem</h2>
