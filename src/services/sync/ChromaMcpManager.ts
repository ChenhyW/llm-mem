...
import { clearDependencyStatus, recordChromaVectorSearchUnavailable, recordHnswVectorSearchUnavailable } from '../../shared/dependency-health.js';
...
export class ChromaMcpManager {
  ...
  private async connectInternal(): Promise<void> {
    ...
    if (!ChromaMcpManager.isUvxAvailable(uvxSpawnCommand, uvxPreflightEnv, process.platform)) {
      ...
      recordHnswVectorSearchUnavailable(message);
