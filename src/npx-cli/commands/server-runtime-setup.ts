...
// Phase 1d back-compat: also clear the legacy LLM_MEM_SERVER_BETA_*
...
export const SERVER_RUNTIME_SETTINGS_KEYS: readonly string[] = Object.freeze([
  'LLM_MEM_RUNTIME',
  'LLM_MEM_SERVER_URL',
  'LLM_MEM_SERVER_API_KEY',
  'LLM_MEM_SERVER_PROJECT_ID',
  'LLM_MEM_SERVER_BETA_URL',
  'LLM_MEM_SERVER_BETA_API_KEY',
  'LLM_MEM_SERVER_BETA_PROJECT_ID',
]);
